...
const collectionState = {
  ...
  episodes: {
    101: Array.from({ length: 16 }, (_, index) => ({
      id: 10100 + index + 1,
      nameCn: `勇者与魔法的旅程 ${index + 1}`,
      name: `Sōretsu naru Ryōiki ${index + 1}`,
      title: `勇者与魔法的旅程 ${index + 1}`,
      originalTitle: `Sōretsu naru Ryōiki ${index + 1}`,
      sort: index + 1,
      ep: index + 1,
      type: 0,
    ...
    102: Array.from({ length: 12 }, (_, index) => ({
      id: 10200 + index + 1,
      nameCn: `迷宫中的料理 ${index + 1}`,
      name: `Dungeon Meshi ${index + 1}`,
      title: `迷宫中的料理 ${index + 1}`,
      originalTitle: `Dungeon Meshi ${index + 1}`,
      sort: index + 25,
      ep: index + 1,
      type: 0,
      airdate: index < 6
    ...
    103: Array.from({ length: 14 }, (_, index) => ({
      id: 10300 + index + 1,
      nameCn: '',
      name: `Cagayake! Girls ${index + 1}`,
      title: `Cagayake! Girls ${index + 1}`,
      originalTitle: `Cagayake! Girls ${index + 1}`,
      sort: index + 1,
      ep: index + 1,
      type: 0,
      airdate: `2009-04-${String(2 + index * 7).padStart(2, '0')}`,
      duration: '24:00',
      durationSeconds: 1440,
      watched: true,
      collectionType: 2,
